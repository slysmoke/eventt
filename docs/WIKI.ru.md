...
- **Фоновый market watch**: app-lifetime свипер обновляет стаканы активных ордеров всех персонажей по мере истечения их ESI-кэшей — история конкуренции, детект релистов и уведомления о перебитых работают без открытого экрана Orders. Между тиками ESI ответы берутся из локального кэша, лишних запросов это не стоит.
