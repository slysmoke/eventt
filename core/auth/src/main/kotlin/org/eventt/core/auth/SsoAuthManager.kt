...
object SsoAuthManager {
    ...
    // accumulated login.eveonline.com session cookies push the request over its header-size
    // limit. Requesting every ESI scope in existence (69 of them, ~2.4KB encoded) tipped that
    // over; only request scopes an endpoint below actually uses.
    private val SCOPES =
        listOf(
